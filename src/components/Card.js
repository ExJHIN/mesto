export class Card {
	constructor(data, clickHandlers,handleCardClick) {
	...
	_createNode() {
		this._node = this._cardTemplate.querySelector(this._selectors.innerContent).cloneNode(true);	//Клонируется только нода которая непосредственно лежит в нем (Li), 
